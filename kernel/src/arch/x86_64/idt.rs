...
pub fn init() {
    ...
    unsafe {
        set_gate(0, super::exceptions::divide_error_handler as usize as u64);
        set_gate(6, super::exceptions::invalid_opcode_handler as usize as u64);
        set_gate(8, super::exceptions::double_fault_handler as usize as u64);
        set_gate(13, super::exceptions::general_protection_fault_handler as usize as u64);
        set_gate(14, super::exceptions::page_fault_handler as usize as u64);
        set_gate(
        ...
        set_gate(0x80, super::syscall::syscall_entry_asm as usize as u64);
    }
